package com.indglobal.nizcare.commons.countrycodes;
    ...
    void setSelectedCountry(Country selectedCountry) {
        ...
        if (!hideNameCode) {
            if (showFullName) {
               ...
               // textView_selectedCountry.setText("(" + selectedCountry.getNameCode().toUpperCase() + ")  +" + selectedCountry.getPhoneCode()+"   "+selectedCountry.getName());
